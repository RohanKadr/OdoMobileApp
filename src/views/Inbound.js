...
import ASNScreen from './ASN';
import ReceiptsScreen from './Receipts';
import PutawayScreen from './Putaway';

const InboundScreen = ({ navigation }) => {
    const [activeTab, setActiveTab] = useState(1); // Default to first tab
    
    const tabs = [
        { id: 1, title: 'ASN', icon: Assets.img_ASN, component: <ASNScreen navigation={navigation} /> },
        { id: 2, title: 'Receipts', icon: Assets.img_receipt, component: <ReceiptsScreen navigation={navigation} /> },
        { id: 3, title: 'Putaway', icon: Assets.img_putaway, component: <PutawayScreen navigation={navigation} /> },
    ];
