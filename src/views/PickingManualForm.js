...
const PickingManualEntryForm = ({ onComplete, onCancel, initialData }) => {
    ...
    const handleSubmit = () => {
        for (const product of formData.products) {
            if (!product.product || !product.demand_qty || !product.done_qty || !product.storage_facility) {
        ...
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Picking Details</Text>
                    ...
                    {formData.products.map((product, index) => (
                        <View key={index} style={styles.productRow}>
                            ...
                            <TextInput
                                ...
                                keyboardType="numeric"
                                value={product.storage_facility}
                                onChangeText={(text) => handleInputChange('storage_facility', text, index)}
                            />
...
export default PickingManualEntryForm;