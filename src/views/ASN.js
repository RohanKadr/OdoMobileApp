...
import { getpurchaseOrderData } from '../controller/ASNController';
import { Services } from '../services/UrlConstant';
import { getDataUsingService } from '../services/Network';

const ASNScreen = ({ route, navigation }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await getDataUsingService(Services.purchaseOrders);
                            ...
                            <View key={index} style={styles.productItem}>
                                ...
                                <View style={styles.productDetails}>
                                    ...
                                    <View style={styles.detailColumn}>
                                        ...
                                        <Text style={styles.detailValue}>{product.buyer}</Text>
                                    </View>
                                    <View style={styles.detailColumn}>
                                        <Text style={styles.detailLabel}>Received Quantity</Text>
                                        <Text style={styles.detailValue}>{product.receivedquantity}</Text>
                                    </View>
                                    <View style={styles.detailColumn}>
                                        <Text style={styles.detailLabel}>Confirmation Date</Text>
                                        <Text style={styles.detailValue}>{product.confirmationDate}</Text>
                                    </View>
                                    <View style={styles.detailColumn}>
